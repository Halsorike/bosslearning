    ...
    public function createDummySchool()
    {
        $data = [
            [
                ...
                'password'          => Hash::make(env('DUMMY_SCHOOL_PASSWORD', 'school@123')),
                'first_name'        => 'School 1',
                'last_name'         => 'Demo 1',
        ...
        $user = [
            [
                ...
                'password'          => Hash::make(env('DUMMY_GUARDIAN_PASSWORD', 'guardian@123')),
                'first_name'        => 'Guardian',
                'last_name'         => 'Demo',
            ...
            [
                ...
                'password'          => Hash::make(env('DUMMY_STUDENT_PASSWORD', 'student@123')),
                'first_name'        => 'Student',
                'last_name'         => 'Demo',
            ...
            [
                ...
                'password'          => Hash::make(env('DUMMY_TEACHER_PASSWORD', 'teacher@123')),
                'first_name'        => 'Teacher',
                'last_name'         => 'Demo',
