# 🏫 Boss School - Multi-Tenant School Management SaaS

Welcome to **Boss School**, a premium, multi-tenant School Management System and Software-as-a-Service (SaaS) platform. This repository contains the complete ecosystem, including the Laravel administrative backend, the Flutter Student/Parent mobile & web application, and the Flutter Staff/Teacher mobile application.

---

## 🚀 System Architecture & Components

The **Boss School** suite consists of three core components:

1. **Boss School Administrative Portal (Backend)**: Built with Laravel, managing multi-tenant database routing (one database per school tenant) and the global Super Admin configuration panel.
2. **Boss School Student App (Frontend)**: Built with Flutter, supporting Web (HTML5/Wasm), Android, and iOS.
3. **Boss School Staff App (Frontend)**: Built with Flutter, supporting Android and iOS.
